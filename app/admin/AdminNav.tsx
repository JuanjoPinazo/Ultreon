  ...
  return (
    <nav className="p-4 space-y-1">
      ...
      <Link
        ...
        className={`flex items-center gap-3 px-4 py-3 text-xs font-bold font-mono tracking-wide uppercase rounded-xl transition-all mt-4 border ${
          pathname === '/admin/demo-center'
            ? 'bg-amber-100 dark:bg-amber-900/50 text-amber-800 dark:text-amber-400 border-amber-300 dark:border-amber-700'
            : 'bg-amber-50 dark:bg-amber-950/20 text-amber-700 dark:text-amber-500 hover:bg-amber-100 hover:text-amber-800 dark:hover:bg-amber-900/40 border-amber-200 dark:border-amber-900/30'
        }`}
      >
        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
