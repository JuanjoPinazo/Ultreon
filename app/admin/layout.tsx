        ...
        <div>
          ...
          <nav className="p-4 space-y-1">
            ...
            <Link
              ...
              className="flex items-center gap-3 px-4 py-3 text-xs font-bold font-mono tracking-wide uppercase text-amber-400 hover:text-amber-300 hover:bg-slate-950/30 rounded-xl transition-all mt-4 border border-amber-900/30 bg-amber-950/10"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
